<template>
  <div class="statistics-order-page">
    ...
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column prop="paidCount" label="已支付订单" width="120" align="right" />
        <el-table-column prop="paidAmount" label="已支付金额" width="120" align="right">
          <template #default="{ row }">
            ¥{{ row.paidAmount || '0.00' }}
          </template>
        </el-table-column>
