  ...
  <div class="oauth-user-page">
    ...
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column prop="unionid" label="UnionID" width="200" show-overflow-tooltip />
...
import { getWechatOAuthUserList } from '@/api/wechat'
...
const getData = async () => {
  ...
  try {
    ...
    const res = await getWechatOAuthUserList(params)
    if (res.success) {
      tableData.value = res.result?.records || res.result?.list || res.result || []
      pagination.total = res.result?.total || 0
    }
  } catch (error) {
    console.error('获取OAuth用户列表失败:', error)
  } finally {
    loading.value = false
  }
}
