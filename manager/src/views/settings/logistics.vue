  ...
  <div class="logistics-page">
    ...
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column prop="code" label="物流代码" width="150" />
        <el-table-column prop="apiUrl" label="API地址" min-width="250" show-overflow-tooltip />
        <el-table-column prop="apiKey" label="API密钥" width="150" show-overflow-tooltip />
...
const getData = async () => {
  ...
  try {
    ...
    // const res = await getLogisticsList(params)
    // if (res.success) {
...
const handleDelete = (row: any) => {
  ElMessageBox.confirm('确认删除此物流公司？', '提示', {
    confirmButtonText: '确定',
    cancelButtonText: '取消',
    type: 'warning'
  }).then(async () => {
    try {
      // const res = await deleteLogistics(row.id)
      // if (res.success) {
