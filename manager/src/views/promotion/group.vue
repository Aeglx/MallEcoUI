  ...
  <div class="group-page">
    ...
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column prop="groupSize" label="成团人数" width="100" align="center" />
        ...
        <el-table-column label="操作" width="250" fixed="right">
          <template #default="{ row }">
            ...
            <el-button link type="primary" size="small" @click="handleViewGoods(row)">查看商品</el-button>
...
import { getGroupList, deleteGroup } from '@/api/promotion'
